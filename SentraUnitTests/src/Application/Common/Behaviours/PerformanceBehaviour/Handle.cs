...
namespace CleanArchitecture.Application.Tests.Behaviours
{
    public class PerformanceBehaviourTests
    {
        ...
        public PerformanceBehaviourTests()
        {
            ...
            _behaviour = new PerformanceBehaviour<TestRequest, TestResponse>(_mockIdentityService.Object, _mockUser.Object, _mockLogger.Object);
        }
        ...
        public async Task Handle_WithLongExecutionTime_LogsPerformanceWarning()
        {
            ...
            var next = new RequestHandlerDelegate<TestResponse>(() => Task.Delay(600).ContinueWith(_ => new TestResponse()));
